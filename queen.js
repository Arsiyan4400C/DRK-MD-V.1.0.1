          ...
          if (video) {
            try {
              ...
              await socket.sendMessage(jid, {
                ...
                caption: `>  © ＤＲＫ ＭＤ 💚*`,
                contextInfo: {
                mentionedJid: ['94771464482@s.whatsapp.net'], // specify mentioned JID(s) if any
                groupMentions: [],
                forwardingScore: 999,
                isForwarded: true,
                forwardedNewsletterMessageInfo: {
                    newsletterJid: '120363299978149557@newsletter',
                    newsletterName: "© ＤＲＫ ＭＤ 💚",
                    serverMessageId: 999
                },
                externalAdReply: {
                    title: '© ＤＲＫ ＭＤ 💚',
                    body: ' ©DRK_ARSIYAN OFC 💚',
                    mediaType: 1,
                    sourceUrl: "https://github.com/Arsiyan4400C",
                    thumbnailUrl: 'https://i.ibb.co/ynpGMvp8/1160.jpg', // This should match the image URL provided above
...
//=================================================================
    ...
    const sessdata = sess.SESSION_ID.split("DRK MD=")[1];
    const filer = File.fromURL(`https://mega.nz/file/${sessdata}`)
    filer.download((err, data) => {
    if(err) throw err
    fs.writeFile(__dirname + '/sessions/creds.json', data, () => {
    console.log("DRK MD Session downloaded ✅")
    })})}
...
//===========================
    ...
    console.log('DRK MD Is Installing... ')
...
//==========================================================================
    //============================================================
    console.log('DRK MD connected to whatsapp ✅')
    const prefix = getPrefix();
    const { commands }= require('./command')
    // Assuming `config` contains all the settings
    let up = `
    🚀 **DRK MD Connected Successfully!** ✅ 
    ...
    **Enjoy your time with us!** 😊`;
    ...
    conn.sendMessage(conn.user.id, { 
        image: { 
            url: 'https://i.ibb.co/4wJnJV5z/8212.jpg' 
        }, 
        caption: up ,
        contextInfo: {
            mentionedJid: ['94771464482@s.whatsapp.net'], // specify mentioned JID(s) if any
    ...
    const inviteLink = "https://whatsapp.com/channel/0029Vb9xu9m65yD6iyidm740";
...
const UPDATE_DETAILS_URL = "https://whatsapp.com/channel/0029Vb9xu9m65yD6iyidm740";
...
async function checkForUpdates(conn) {
  ...
  if (lastVersion !== updateDetails.version) {
    ...
    // Notify the owner
    const message = `🌟 *DRK MD Update Available!*\n\n` +
    ...
    await conn.sendMessage(conn.user.id, { 
        ...
        contextInfo: {
            externalAdReply: {
                ...
                mediaType: 1,
                sourceUrl: "https://github.com/Arsiyan4400C",
                thumbnailUrl: 'https://i.ibb.co/ynpGMvp8/1160.jpg', 
            }
        }
    });
...
if(config.WELCOME === true){
    conn.ev.on('group-participants.update', async (update) => {
        ...
        try {
            ...
            for (const participant of participants) {
                try {
                    let message = '';
                    let profilePicUrl = `https://i.ibb.co/4wJnJV5z/8212.jpg`;
    ...
    *Hey @${participant.split('@')[0]}!* 👋
    ...
    > 🟢 *DRK MD WhatsApp Bot* is up and running!
    ...
    *© ＤＲＫ ＭＤ - MD* 
    *💻 GitHub:* github.com/Arsiyan4400C
                            `;
                        }
    ...
    *© ＤＲＫ ＭＤ - MD* 
    *💻 GitHub:* https://github.com/Arsiyan4400C
                            `;
                        }
                    }
...
//==========================================================================    
    ...
    const ZIP = await axios.get(
          "https://i.ibb.co/ynpGMvp8/1160.jpg"
        );
...
await conn.sendMessage(from, { text: "❌ ```Another Bot's message Detected :``` 📚 *Removed By DRK MD* ❗\nAnti Bot System on..." })
...
//============================================================================
    ...
    app.get("/", (req, res) => {
    res.send("hey I am alive, DRK MD Is started✅");
    });
